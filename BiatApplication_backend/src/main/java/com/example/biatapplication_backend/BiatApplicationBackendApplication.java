package com.example.biatapplication_backend;

import com.example.biatapplication_backend.Entities.*;
import com.example.biatapplication_backend.Repository.CountryRepository;
import com.example.biatapplication_backend.Repository.CurrencyRepository;
...
public class BiatApplicationBackendApplication  implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(BiatApplicationBackendApplication.class, args);
    }
